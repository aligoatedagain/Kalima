...
const Footer = () => {
  ...
  return (
    <footer className="bg-app-dark text-white py-12" dir={isRTL ? 'rtl' : 'ltr'}>
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-right">
          {/* Learn Language Section */}
          <div>
            <h3 className="text-xl font-bold mb-4">{t('learnLanguage')}</h3>
            <ul className="space-y-2">
              <li><a href="#" className="hover:text-app-primary transition-colors">{t('suggestedClips')}</a></li>
              <li><a href="#" className="hover:text-app-primary transition-colors">{t('vocabLists')}</a></li>
              <li><a href="#" className="hover:text-app-primary transition-colors">{t('tests')}</a></li>
              <li><a href="#" className="hover:text-app-primary transition-colors">{t('languageLevels')}</a></li>
            </ul>
          </div>

          {/* About Section */}
          <div>
            <h3 className="text-xl font-bold mb-4">{t('aboutPlatform')}</h3>
            <ul className="space-y-2">
              <li><a href="#" className="hover:text-app-primary transition-colors">{t('aboutUs')}</a></li>
              <li><a href="#" className="hover:text-app-primary transition-colors">{t('team')}</a></li>
              <li><a href="#" className="hover:text-app-primary transition-colors">{t('terms')}</a></li>
              <li><a href="#" className="hover:text-app-primary transition-colors">{t('privacyPolicy')}</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="hover:text-app-primary transition-colors">{t('faq')}</a></li>
              <li><a href="#" className="hover:text-app-primary transition-colors">{t('support')}</a></li>
              <li><a href="#" className="hover:text-app-primary transition-colors">{t('contactUs')}</a></li>
              <li><a href="#" className="hover:text-app-primary transition-colors">{t('suggestions')}</a></li>
            </ul>
          </div>

          {/* Join Waitlist Section */}
          <div>
            <h3 className="text-xl font-bold mb-4">{t('joinNow')}</h3>
            <p className="mb-4 text-gray-300">{t('waitlistText')}</p>
            <div className="flex flex-col gap-2">
              <Button
                variant="outline"
                className="border-app-primary text-app-primary hover:bg-app-primary hover:text-white transition-colors w-full"
              >
                {t('joinWaitlist')}
              </Button>
            </div>
        ...
        {/* Footer Bottom */}
        <div className="border-t border-gray-800 mt-8 pt-6 text-center">
          <p className="text-gray-400">{t('copyright', { year: currentYear })}</p>
        </div>
      </div>
    </footer>
  );
