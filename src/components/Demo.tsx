...
//                     <p className="text-sm text-gray-600">مفردات إنجليزية أساسية: التكنولوجيا</p>
//                   </div>
//                   <div>
...
//                     <p className="text-sm text-gray-600">أساسي، ضروري</p>
//                   </div>
//                   <div className="bg-app-light bg-opacity-50 p-2 rounded-lg">
//                     <p className="font-medium text-gray-900">explore</p>
//                     <p className="text-sm text-gray-600">يستكشف</p>
//                   </div>
//                   <div className="bg-app-light bg-opacity-50 p-2 rounded-lg">
//                     <p className="font-medium text-gray-900">vocabulary</p>
//                     <p className="text-sm text-gray-600">مفردات</p>
//                   </div>
//                 </div>
//               </div>
//               <h3 className="font-bold text-gray-900 mb-2">الاختبار السريع</h3>
//               <div className="p-3 border border-gray-200 rounded-lg mb-3">
//                 <p className="text-sm font-medium mb-2">أكمل الجملة: "Today we will ______ new technology terms."</p>
//                 <div className="space-y-2">
